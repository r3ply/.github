...
This is an open source project dedicated to making add comments to your websites as simple as email. 
...
Read the [docs](https://r3ply.com/docs/)

- [Getting started](https://r3ply.com/docs/getting-started/)
- [Overview](https://r3ply.com/docs/overview/)
- [Configuration](https://r3ply.com/docs/config/)
- [Templating](https://r3ply.com/docs/templating/)
- [`re` the r3ply CLI](https://r3ply.com/docs/cli/)
- [Schemas](https://r3ply.com/docs/schemas/)
- [API](https://r3ply.com/docs/api/)
